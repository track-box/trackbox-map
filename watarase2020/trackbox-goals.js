...
function TrackboxGoals(map, trackboxMap) {
	...
	this._utm.xbase = Math.floor(this._utm.xmin / 100000) * 100000;
	this._utm.ybase = Math.floor(this._utm.ymin / 100000) * 100000;
...
TrackboxGoals.prototype._getDigitLatLon = function(digit) {
	...
	if (x > this._utm.xmax) x -= 100000;
	if (x < this._utm.xmin) x += 100000;
	if (y > this._utm.ymax) y -= 100000;
	if (y < this._utm.ymin) y += 100000;
